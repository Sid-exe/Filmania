...
<body>
    ...
    <form method="post" name="blog" action="postblog.php">
        ...
        <textarea  name="blog" rows="6" cols="100"  placeholder="Write your Blog..."></textarea>
        <br><br>
...
if(isset($_POST['submit']))
{
   ...
   $blog=$_POST['blog'];
   $name=$_SESSION['name'];
   $sql="INSERT INTO `blog` (`name`, `genre`, `genrename`, `blog`) VALUES ('$name', '$genre', '$genrename', '$blog')";
