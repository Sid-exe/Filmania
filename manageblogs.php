...
<?php 
			...
			$res=mysqli_query($conn,"SELECT * FROM `blog` ORDER BY `blog`.`blno` ASC;");
			...
			while($row=mysqli_fetch_assoc($res))
			{
                ...
                echo "Blog: "; 
                echo $row['blog'];echo "<br>";echo "<br>";
                
                ?>
                <form action="manageblogs.php" method="post">
                <button type="submit" name="delete" value="<?=$row['blno'];?>" class="btn btn-danger btn-sm">Delete</button>
                </form>
                <?php
                echo "</div>";
...
{
    $blno = mysqli_real_escape_string($conn, $_POST['delete']);

    $query = "DELETE FROM blog WHERE blno='$blno' ";
