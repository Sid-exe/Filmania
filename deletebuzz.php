...
<div class="reviews">
        <?php 
			...
			while($row=mysqli_fetch_assoc($res))
			{
                ...
                ?>
                <form action="deletebuzz.php" method="post">
                <button type="submit" name="delete" value="<?=$row['bno'];?>" class="btn btn-danger btn-sm">Delete</button>
                </form>
                <?php 
                 echo "</div>";
			}
...
{
    $bno = mysqli_real_escape_string($conn, $_POST['delete']);

    $query = "DELETE FROM buzz WHERE bno='$bno' ";
